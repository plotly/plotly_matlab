...
Interactive web-based plots play a central role in scientific research.
...
The interactive nature of these plots makes them richer in information than plain images because the user can zoom and pan to see finer details and, in the case of three-dimensional plots, they can also rotate and change the perspective of view of those plots. Hovering over data points displays tooltips with numerical data, which also makes them more informative. Additionally, the web-based nature of these plots makes them easier to share between researchers using different operating systems and software, when compared to language-specific figure objects.
...
plots[^1]. While other languages were supported by Plotly, the Octave[@octave] and MATLAB[@matlab] ecosystems, which are widely used in scientific research, both lacked a plotting library that is interactive and web-based.
