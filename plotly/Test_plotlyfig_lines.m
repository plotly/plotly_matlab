classdef Test_plotlyfig_lines < PlotlyTestCase
    methods
        ...
        function testCompassPlotData(tc)
            ...
            shaftR = {[0 1.4142135624], [0 2.2360679775], [0 1.4142135624], [0 2.2360679775]};
            shaftTheta = {[0 45], [0 -26.565051177], [0 135], [0 -153.43494882]};
            shaftText = {'r: 1.41<br>θ: 45.00', 'r: 2.24<br>θ: -26.57', 'r: 1.41<br>θ: 135.00', 'r: 2.24<br>θ: -153.43'};
            if is_octave()
                headR = {[1.4142135624 1.1352924244 1.4142135624 1.1352924244], ...
                         [2.2360679775 1.7950549357 2.2360679775 1.7950549357], ...
                         [1.4142135624 1.1352924244 1.4142135624 1.1352924244], ...
                         [2.2360679775 1.7950549357 2.2360679775 1.7950549357]};
                headTheta = {[45 49.763641691 45 40.236358309], ...
                             [-26.565051177 -21.801409486 -26.565051177 -31.328692868], ...
                             [135 139.76364169 135 130.23635831], ...
                             [-153.43494882 -148.67130713 -153.43494882 -158.19859051]};
            else
                headR = {[1.4142135624 1.1370136323 1.4142135624 1.1370136323], ...
                         [2.2360679775 1.7977764043 2.2360679775 1.7977764043], ...
                         [1.4142135624 1.1370136323 1.4142135624 1.1370136323], ...
                         [2.2360679775 1.7977764043 2.2360679775 1.7977764043]};
                headTheta = {[45 50.710593137 45 39.289406863], ...
                             [-26.565051177 -20.85445804 -26.565051177 -32.275644315], ...
                             [135 140.71059314 135 129.28940686], ...
                             [-153.43494882 -147.72435569 -153.43494882 -159.14554196]};
            end
            for i = 1:4
                tc.verifyEqualStructs(p.data{i}, struct( ...
                    "type", "scatterpolar", ...
