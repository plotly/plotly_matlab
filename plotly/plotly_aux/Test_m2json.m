classdef Test_m2json < PlotlyTestCase
    methods
        ...
        function testInRange0to10(tc)
            ...
            expected = strcat("[2.23456789,3.23456789,4.23456789,5.23456789,", ...
                    "6.23456789]");
            tc.verifyEqual(m2json(values), expected);
        end
        ...
        function test2dArrayInRange0to10(tc)
            ...
            expected = strcat("[[2.234,3.234,4.234,5.234,6.234],", ...
        ...
        function testLowPrecisionInRange1e6to1e5(tc)
            ...
            expected = strcat("[2.234e-06,3.234e-06,4.234e-06,5.234e-06,", ...
                    "6.234e-06]");
            tc.verifyEqual(m2json(values), expected);
        end
        ...
        function testInRange1e6to1e5(tc)
            ...
            expected = strcat("[2.23456789e-06,3.23456789e-06,4.23456789e-06,", ...
        ...
        function testInRange1e14Plus0to1(tc)
            ...
            expected = strcat("[100000000000001,100000000000002,",...
        ...
        function testInRange1e14Plus1e7Plus0to1(tc)
            ...
            expected = strcat("[100000010000001,100000010000002,", ...
        ...
        function testLogScaledVariables(tc)
            ...
            expected = strcat("[100000000000010,100000000000100,", ...
        ...
        function testInRangeMinus10to0(tc)
            values = -(1 + (1:5) + 0.23456789);
            expected = strcat("[-2.23456789,-3.23456789,-4.23456789,", ...
        ...
        function testInRangeMinus1e5toMinus1e6(tc)
            values = -1e-6 * (1 + (1:5) + 0.23456789);
            expected = strcat("[-2.23456789e-06,-3.23456789e-06,", ...
        ...
        function testInRangeMinus1e14Plus0to1(tc)
            values = -1e14 + (1:5) + 0.23456789;
            expected = strcat("[-99999999999998.8,-99999999999997.8,", ...
