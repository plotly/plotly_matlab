...
plotlyref = struct('scatter',plotlyref.scatter,'area',plotlyref.area,'bar',plotlyref.bar,...
                'box',plotlyref.box,'contour',plotlyref.contour,'heatmap',plotlyref.heatmap,... 
                'histogram',plotlyref.histogram,'histogram2d',plotlyref.histogram2d, ...
                 'histogram2dcontour',plotlyref.histogram2dcontour,'layout',plotlyref.layout,'online','Access the online docs!');
try
