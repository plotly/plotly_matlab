        ...
        function testLinePlotLayout(tc)
            ...
            tc.verifyEqualStructs(p.layout, struct( ...
                ...
                xaxis1 = struct( ...
                    ...
                    ticklen = PlotlyTestCase.Any(), ...
                    tickcolor = PlotlyTestCase.Any(), ...
                    tickwidth = 1, ...
                    tickangle = 0, ...
                    ticks = "inside", ...
                    showgrid = false, ...
                    gridcolor = PlotlyTestCase.Any(), ...
                    type = 'linear', ...
                    showticklabels = true, ...
                    tickmode = "array", ...
        ...
        function testStemPlotData(tc)
            ...
            tc.verifyEqualStructs(p.data{1}, struct( ...
                ...
                marker = struct( ...
                    ...
                    line = struct( ...
                        width = 1, ...
                        color = {repmat({"rgba(0,0,0,0)" PlotlyTestCase.Any() "rgba(0,0,0,0)"},1,10)'} ...
                    ), ...
